...
export default function DashboardMenu({
   ...
   * ==========================================================
   *
   * roles = rôles autorisés à voir le menu.
   *
  ...
  const menuItems = [
     ...
     * ----------------------------------------------------------
     *
     * Secrétaire + agent peuvent gérer les inscriptions.
     */
     ...
     * ----------------------------------------------------------
     *
     * Seuls superadmin, admin et comptable.
     */
     ...
     * ----------------------------------------------------------
     *
     * Secrétaire peut consulter les rapports.
     */
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Rôle actuel */}
            <p className="text-[10px] text-indigo-400 mt-1 uppercase font-semibold">
        ...
        <div className="p-3 mt-auto border-t border-slate-800 bg-slate-900/30 space-y-1.5 flex-shrink-0">
          ...
          >
            <LogOut
              size={18}
              className="flex-shrink-0 text-red-500 group-hover:text-red-300"
            />
