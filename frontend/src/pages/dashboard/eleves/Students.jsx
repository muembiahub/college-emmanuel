...
export default function ListEleves() {
  ...
  useEffect(() => {
    ...
    if (sortBy === "nom") {
      ...
      filtered.sort((a, b) => new Date(b.date_naissance) - new Date(a.date_naissance));
    }
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border-b border-white/10">
                    ...
                    <th className="px-6 py-4 text-left font-semibold text-indigo-300">Année</th>
                        ...
                        <tr className="border-b border-white/5 hover:bg-white/5 transition-all duration-200 group">
                          ...
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <button
                                className="p-2 rounded-lg bg-blue-500/20 border border-blue-500/30 text-blue-300 hover:bg-blue-500/30 hover:border-blue-500/50 transition-all duration-200"
                                title="Modifier"
                              >
                                <Edit size={16} />
                              </button>
                              <button
                                className="p-2 rounded-lg bg-red-500/20 border border-red-500/30 text-red-300 hover:bg-red-500/30 hover:border-red-500/50 transition-all duration-200"
                                title="Supprimer"
                              >
                                <Trash2 size={16} />
                              </button>
