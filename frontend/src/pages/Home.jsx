...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-blue-50/50 text-slate-900 overflow-hidden space-y-12 sm:space-y-20 pb-20">
      ...
      {/* HERO SECTION */}
      <section className="relative h-[550px] sm:h-[650px] overflow-hidden rounded-2xl sm:rounded-[40px] max-w-7xl mx-4 sm:mx-auto mt-4 sm:mt-8 shadow-xl border border-white/50">
        <img
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-950/95 via-blue-950/80 sm:to-transparent" />

        <div className="relative z-10 flex h-full items-center">
          <div className="max-w-3xl px-6 sm:px-12">
            <span className="inline-block rounded-full bg-yellow-400 px-4 sm:px-5 py-2 font-bold text-blue-950 shadow-md text-xs sm:text-sm">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-xl text-blue-100 font-medium drop-shadow-sm">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-4 sm:gap-5">
              <button
                ...
                className="w-full sm:w-auto rounded-full bg-yellow-400 px-8 py-3.5 sm:py-4 font-bold text-blue-950 hover:bg-yellow-300 shadow-lg transition text-center"
              >
                Découvrir nos filières
              </button>
              <Link
                to="/contact"
                className="w-full sm:w-auto rounded-full border-2 border-white px-8 py-3.5 sm:py-4 font-semibold text-white hover:bg-white hover:text-blue-900 transition text-center"
              >
                Nous contacter
              </Link>
            </div>
      ...
      <section className="relative py-12 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-yellow-100 px-5 py-2 shadow-sm ring-1 ring-yellow-200">
              ...
              <span className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-yellow-800">
                Pourquoi choisir le Collège Emmanuel ?
              </span>
            </div>
          </div>

          <h2 className="mt-6 sm:mt-8 text-3xl sm:text-5xl font-extrabold leading-tight text-blue-950">
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-base sm:text-lg leading-7 sm:leading-8 text-slate-700">
        ...
        <div className="mt-12 sm:mt-16 grid gap-6 sm:gap-8 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            <div key={index} className="group relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 sm:p-8 shadow-sm transition hover:-translate-y-2 hover:border-yellow-300 hover:shadow-lg">
              ...
              <div className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-2xl bg-blue-50 text-blue-900 shadow-sm transition group-hover:scale-110 group-hover:bg-yellow-400 group-hover:text-blue-950">
                <span className="material-symbols-outlined flex items-center justify-center text-3xl sm:text-4xl leading-none" style={{ fontVariationSettings: "'FILL' 1, 'wght' 500, 'GRAD' 0, 'opsz' 48" }}>
                  {item.icon}
                </span>
              </div>
              <h3 className="mt-6 sm:mt-8 text-xl sm:text-2xl font-bold text-slate-900">{item.title}</h3>
              <p className="mt-3 sm:mt-4 text-sm sm:text-base leading-6 sm:leading-7 text-slate-600">{item.desc}</p>
              <button className="mt-6 sm:mt-8 flex items-center gap-2 text-sm sm:text-base font-semibold text-blue-900 transition group-hover:text-yellow-600">
                En savoir plus
              </button>
            </div>
          ))}
      ...
      {/* NOS CHIFFRES */}
      <section className="rounded-2xl sm:rounded-[40px] bg-blue-950 py-12 sm:py-16 text-white mx-4 sm:mx-6 shadow-2xl">
        <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4 max-w-7xl mx-auto px-4 sm:px-6">
          {[
            ...
            <div key={index} className="text-center">
              ...
              <p className="mt-2 sm:mt-3 text-sm sm:text-lg text-blue-100">
                {item.title}
              </p>
            </div>
          ))}
      ...
      {/* OPTIONS DYNAMIQUES */}
      <section id="programmes" className="rounded-2xl sm:rounded-[2.5rem] bg-white p-6 sm:p-8 lg:p-12 shadow-xl max-w-7xl mx-4 sm:mx-auto border border-slate-100">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Nos Options</h2>
            <p className="text-sm sm:text-base text-slate-500">Explorez les programmes académiques</p>
          </div>
          <span className="self-start sm:self-auto text-xs sm:text-sm font-semibold text-blue-900 bg-blue-50 border border-blue-100 px-4 sm:px-6 py-2 sm:py-3 rounded-full">
          ...
          {loading ? (
            ...
            options.map((opt) => (
              <div key={opt.option_id} className="group overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-lg hover:shadow-2xl transition duration-300">
                <div className="h-40 sm:h-48 overflow-hidden relative bg-blue-950 flex items-end p-4 sm:p-6">
                  ...
                  <div className="relative z-10 w-full">
                    <h3 className="text-xl sm:text-2xl font-bold text-white drop-shadow-md">{opt.nom_option}</h3>
                  </div>
                </div>
                
                <div className="p-4 sm:p-6">
                  <p className="text-slate-500 text-xs sm:text-sm">Formation reconnue et encadrée par le Collège Emmanuel.</p>
                </div>
              </div>
            ))
          )}
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center gap-3 group">
        ...
        <a
          ...
          className="flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-green-500 text-white shadow-2xl transition hover:scale-110 active:scale-95 animate-bounce"
          title="Discuter sur WhatsApp"
        >
          <FaWhatsapp className="h-7 w-7 sm:h-9 sm:w-9" />
        </a>
      </div>
